...
#    Updated: 2025/01/28 11:13:51 by rtruvelo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#------------------------# ==== MANDATORY FILES ==== #-------------------------#
SRC	= main.cpp Server.cpp Socket.cpp Cluster.cpp UtilParsing.cpp ConfigParser.cpp HttpConfig.cpp LocationConfig.cpp ServerConfig.cpp
